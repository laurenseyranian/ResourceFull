...
<body style="background-image: url('/img/map.png')">
	...
	<h1>Keeping Neighbors Safe Where They Are</h1>
		<div class="addBox">
			<form:form action="/community/process" method="post"
